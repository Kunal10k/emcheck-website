...
<head>
    ...
    <title>Emcheck</title>
    <link rel="shortcut icon" href="assets/img/emcheck icon logo.png" type="image/x-icon">

    <link rel="stylesheet" href="assets/css/style.css">
    <link rel="stylesheet" href="assets/css/media.css">
    <link rel="stylesheet" href="assets/css/animated.css">
    <link rel="stylesheet" href="css/animited.css">
    <link rel="icon" type="image/x-icon" href="./img/likhai-logo 2-new.png">
            ...
            <nav class="navbar navbar-expand-lg navbar-light d-none d-lg-block">
                <div class="container px-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-0   mb-2 mb-lg-0" id="primary">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="carrer.php">Carrer</a>
                            </li>
                    ...
                    <div class="search-box">
                        <a href="tel:+913325370069" class="search-box-btn">
                            <span class="search-box-icon">
                                <i class="fa-solid fa-phone"></i>
                            </span>
                            <span>91 33-25370069</span>
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" id="primary">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="Freight.html">ABC</a></li>
                                        <!-- <li><a class="dropdown-item" href="Containerisation.html">Containerisation</a></li>
                                <li><a class="dropdown-item" href="Voyage.html">Voyage Execution</a></li>
                                <li><a class="dropdown-item" href="Maritime.html">Maritime Consultancy</a></li> -->
                                    </ul>
                                </li>
