  ...
  <div class="container">
    <div class="footer">
      ...
      <div class="footer-column">
        <a href="index.php">
          <div class="logo">
            <img src="assets/img/emcheck logo.png" alt="Company Logo" style="background-color:#fff; border-radius:3px;">
          </div>
        </a>

        <p class="pt-4">
          Most oils are stripped of their essence before they reach your kitchen. We took a different path.
        </p>
      ...
      <div class="footer-column">
        ...
        <ul class="list-unstyled contact-info">
          <li>
            ...
            174, Bipin Ganguly Road,<br>
            Dum Dum, Kolkata – 700030
          </li>
          <li>
...
<section class="footer-bottom">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <div class="copyright">
          © 2025 Emcheck. Designed by <span>Esspesoft</span>
        </div>
